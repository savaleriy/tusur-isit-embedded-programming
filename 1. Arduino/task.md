...
## 1. Реализация мигания светодиодом с помощью микроконтроллера ATmega328.
#### Описание
...
##  2. Реализация мигания светодиодом с помощью кнопки
#### Описание
...
## 3. Реализация изменения яркости светодиода с использованием потенциометра
#### Описание
...
## 4. Реализация управления светодиодом с помощью потенциометра
##### Описание
...
##  5. Реализация управления светодиодами с помощью потенциометра
##### Описание
...
##  6. Фильтрация значений фоторезистора
##### Описание
...
## 8. Реализовать последовтельность светодиодов и придумать алгоритм для управления бегущими огнями.
##### Описание
...
##  9. Подключите семисегментный индикатор через сдвиговый регистр.
##### Описание
...
## 10. Реализовать опрос линии I2C
##### Описание
...
## 11. Реализовать включение светодиодов по UART
##### Описание
...
## 12. Необходимо любыми доступными средствами индикации отобразить сигнал с любого датчика. 
##### Описание
...
## 13. Обработка информации с двух датчиков 
##### Описание
